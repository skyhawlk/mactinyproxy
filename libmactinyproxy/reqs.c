 ...
 */
#define SSL_REDIRECT_PERM "HTTP/1.0 302 Moved Permanently"
#define SSL_REDIRECT_HEADER "Location: http://www.example.org/index.asp"
...
BAD_REQUEST_ERROR:
       ...
       // if (config->filter) {
                ...
                if (ret) {
                        //Avishay - https - so reverse/redirect to local block page -
